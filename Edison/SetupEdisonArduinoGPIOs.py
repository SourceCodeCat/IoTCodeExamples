...
rulesMatrix.append(["IO14",200,"low"  ,"*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO14",44 ,"mode0","*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO14",232,"OE"   ,"*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO14",228,"PUD"  ,"*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO15",201,"low"  ,"*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO15",45 ,"mode0","*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO15",233,"OE"   ,"*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO15",209,"PUD"  ,"*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO16",202,"low"  ,"*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO16",46 ,"mode0","*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO16",234,"OE"   ,"*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO16",210,"PUD"  ,"*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO17",203,"low"  ,"*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO17",47 ,"mode0","*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO17",235,"OE"   ,"*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO17",211,"PUD"  ,"*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO18",204,"low"  ,"*"   ,"*"    ,"*"    ,"low"  ,"*"    ])
rulesMatrix.append(["IO18",14 ,"mode0","*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO18",28 ,"*"    ,"*"   ,"*"    ,"*"    ,"mode1","*"    ])
rulesMatrix.append(["IO18",236,"OE"   ,"*"   ,"*"    ,"*"    ,"OE"   ,"*"    ])
rulesMatrix.append(["IO18",212,"PUD"  ,"*"   ,"*"    ,"*"    ,"PUD"  ,"*"    ])
rulesMatrix.append(["IO19",205,"low"  ,"*"   ,"*"    ,"*"    ,"low"  ,"*"    ])
rulesMatrix.append(["IO19",165,"mode0","*"   ,"*"    ,"*"    ,"*"    ,"*"    ])
rulesMatrix.append(["IO19",27 ,"*"    ,"*"   ,"*"    ,"*"    ,"mode1","*"    ])
rulesMatrix.append(["IO19",237,"OE"   ,"*"   ,"*"    ,"*"    ,"OE"   ,"*"    ])
rulesMatrix.append(["IO19",213,"PUD"  ,"*"   ,"*"    ,"*"    ,"PUD"  ,"*"    ])
#-----------------------------------------------------------------------------------------
...
def generateInstructions(TYPE,PIN,OE,PUD,DIRECTION):
	...
	#---------------------------------------------------------------------------------	
	if typeIsSupported:
		#If the first GPIO defined in the specificSettings Matrix is not already exported then we can use it
